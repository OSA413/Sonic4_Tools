...
pub fn write(target: &mut [u8], pointer: usize, data: u8, what: &str) -> Result<(), CommonBinaryError> {
...
mod tests {
    ...
    fn test_write_le_0() {
        let mut target = [0; 3];
        write(&mut target, 0, 0x12, "test_write_le_0").unwrap();
    ...
    fn test_write_le_1() {
        let mut target = [0; 3];
        write(&mut target, 1, 0x12, "test_write_le_1").unwrap();
    ...
    fn test_write_le_2() {
        let mut target = [0; 3];
        write(&mut target, 2, 0x12, "test_write_le_2").unwrap();
    ...
    fn test_write_be_0() {
        let mut target = [0; 3];
        write(&mut target, 0, 0x12, "test_write_be_0").unwrap();
        assert_eq!(target, [0x12, 0, 0]);
    }
    ...
    fn test_write_be_1() {
        let mut target = [0; 3];
        write(&mut target, 1, 0x12, "test_write_be_1").unwrap();
        assert_eq!(target, [0, 0x12, 0]);
    }
    ...
    fn test_write_be_2() {
        let mut target = [0; 3];
        write(&mut target, 2, 0x12, "test_write_be_2").unwrap();
        assert_eq!(target, [0, 0, 0x12]);
    }
