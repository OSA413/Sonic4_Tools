...
impl MdSet {
    ...
    pub fn new_from_src_ptr_name(
        ...
        let x_tiles = binary_reader::u16::read(source, ptr, &Endianness::Little, "x_tiles from MdSet header")?;
        let y_tiles = binary_reader::u16::read(source, ptr + 2, &Endianness::Little, "y_tiles from MdSet header")?;
        ...
        for _ in 0..entries_number {
            let unknown1 = binary_reader::u8::read(source, entry_pointer, "unknown1")?;
            entry_pointer += 0x01;
    ...
    pub fn write(&self) -> Result<Vec<u8>, CommonBinaryError> {
        ...
        for entry in &self.entries {
            binary_writer::u8::write(&mut result, entry_pointer, entry.unknown1, "unknown1")?;
            entry_pointer += 0x01;
        }
